...
UNFROZEN_LAYERS_ENCODER = 1
UNFROZEN_LAYERS_DECODER = 4
...
model.compile(optimizer=Adam(learning_rate=LEARNING_RATE), loss=dice_loss, metrics=["accuracy", dice_coef])
